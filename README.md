...
<img src="https://img.shields.io/badge/✿-Hello_Kitty_Dev_Space-FFB7C5?style=for-the-badge&labelColor=FF91AF&color=FFB7C5" alt="Hello Kitty Dev Space"/>

# 🎀 Kawaii Code & Sweet Commits

*"El código más lindo es el que funciona perfecto, igual que un lazo bien puesto."*

![Hello Kitty](https://img.shields.io/badge/🐱_Hello_Kitty-FF91AF?style=flat-square&labelColor=FFB7C5)
![Desarrolladora](https://img.shields.io/badge/👩‍💻_Dev_en_Formación-FFD6E0?style=flat-square&labelColor=FF91AF&color=FFD6E0)
![El Salvador](https://img.shields.io/badge/🌸_El_Salvador-FFB7C5?style=flat-square&labelColor=FF91AF)
...
Desarrolladora de software en formación, apasionada por escribir código limpio y con estilo. Cuando no estoy resolviendo problemas en **PostgreSQL**, probablemente estoy decorando mi setup, explorando mapas en **Roblox** o coleccionando cosas de **Hello Kitty**.
...
- ✨ **Dato curioso:** Cada bug corregido merece un sticker de recompensa 🐱
...
¿Encontraste algo que no funciona? ¡Cuéntame con mucho amor! Llega directo a mi correo automáticamente. 🐱
